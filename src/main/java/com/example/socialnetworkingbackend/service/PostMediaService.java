...
public class PostMediaService {
    ...
    @Async("taskExecutor")
    public void processPostMedia(Long postId, List<File> files, List<String> contentTypeList, String singerName) {
    ...
    private void saveMediaToPost(Post post, MediaResponseDto dto) {
        ...
        Media media = mediaRepository.findMediaByPublicId(dto.getPublicId())
                .orElseThrow(() -> new NotFoundException(
                        ErrorMessage.Media.ERR_NOT_FOUND_MEDIA,
                        new String[]{dto.getPublicId()}));
